...
def clientes():
    ...
    if request.method == 'POST':
        ...
        cursor.execute('INSERT INTO cliente (nombre, telefono, correo, direccion) VALUES (%s, %s, %s, %s)',
...
def edit_cliente(id):
    ...
    if request.method == 'POST':
        ...
        cursor.execute('UPDATE cliente SET nombre=%s, telefono=%s, correo=%s, direccion=%s WHERE cliente_id=%s',
...
def productos():
    ...
    if request.method == 'POST':
        ...
        cursor.execute('INSERT INTO producto (nombre, descripcion, precio, cantidad, fecha_vencimiento) VALUES (%s, %s, %s, %s, %s)',
...
def edit_producto(id):
    ...
    if request.method == 'POST':
        ...
        cursor.execute('UPDATE producto SET nombre=%s, descripcion=%s, precio=%s, cantidad=%s, fecha_vencimiento=%s WHERE producto_id=%s',
...
def almacenamientos():
    ...
    if request.method == 'POST':
        ...
        cursor.execute('INSERT INTO cuarto_refrigeracion (capacidad, temperatura, medidas, tipo_trabajo, tipo_producto, humedad, tiempo_rotacion) VALUES (%s, %s, %s, %s, %s, %s, %s)',
                       (capacidad, temperatura, medidas, tipo_trabajo, tipo_producto, humedad, tiempo_rotacion))
        conn.commit()
        cursor.close()
        conn.close()
    ...
    cursor.close()
    conn.close()
    return render_template('almacenamiento-productos.html', almacenamientos=almacenamientos)
...
def edit_almacenamiento(id):
    ...
    if request.method == 'POST':
        ...
        cursor.execute('UPDATE cuarto_refrigeracion SET capacidad=%s, temperatura=%s, medidas=%s, tipo_trabajo=%s, tipo_producto=%s, humedad=%s, tiempo_rotacion=%s WHERE cuarto_id=%s',
                       (capacidad, temperatura, medidas, tipo_trabajo, tipo_producto, humedad, tiempo_rotacion, id))
        conn.commit()
        cursor.close()
        conn.close()
    ...
    cursor.close()
    conn.close()
    return render_template('almacenamiento-productos.html', almacenamiento=almacenamiento)
...
def pedidos():
    ...
    if request.method == 'POST':
        ...
        cursor.execute('INSERT INTO pedido (cliente_id, fecha_pedido, estado, ciudad, cantidad_variable) VALUES (%s, %s, %s, %s, %s)',
...
def edit_pedido(id):
    ...
    if request.method == 'POST':
        ...
        cursor.execute('UPDATE pedido SET cliente_id=%s, fecha_pedido=%s, estado=%s, ciudad=%s, cantidad_variable=%s WHERE pedido_id=%s',
